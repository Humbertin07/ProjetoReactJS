...
class pagamentoracao extends React.Component {
  ...
  salvar() {
    firebase.database().ref('/valordaracao').push({
      opcao: this.opcao,
    });
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text}>
          {
            'Você está prestes a ajudar o Rio Grande do Sul, doando um valor definido por ti, para que sejam comprados Quilos de ração para os animais em geral!'
          }
        </Text>
        <Text style={styles.text}>
          {
